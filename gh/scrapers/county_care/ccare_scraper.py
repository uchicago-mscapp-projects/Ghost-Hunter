...
from .search_parameters.search_parameters import PROVIDER_TYPES, \
...
def scrape_ccare(start_over=False, monitoring=True):
    ...
    coordinates_file = pathlib.Path(__file__).parent / "search_parameters/cook_county_coordinates_zips.json"
...
def re_scrape(re_re_do=False, monitoring=True):
    ...
    """
    scnd_scrape_file = pathlib.Path(__file__).parent / "scraped_data/re_scrape_ccare.json"
